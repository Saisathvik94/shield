...
import { updateTeamSchema } from "@/lib/organization/validation";
import { z } from "zod";

const patchSchema = updateTeamSchema.extend({
...
export async function GET(
  ...
  try {
    ...
    const team = await getTeamById(id, organizationId);
...
export async function PATCH(
  ...
  try {
    ...
    const updated = await updateTeam(id, organizationId, data);
